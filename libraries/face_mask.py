from config import  BLUR_FILTER_SIZE, CROP_SIZE, MAX_FACE_HEIGHT, MIN_FACE_HEIGHT, MIN_NEIGHBORS_TRAIN, MIN_SIZE_TRAIN, RESIZE_SIZE, SCALE_FACTOR_TRAIN
from .hog import Hog
...
class FaceMask:
    ...
    def geometrical_face_model_roi_image(self, image: numpy.ndarray) -> numpy.ndarray:
        ...
        try:
            coordinates = self.geometrical_face_model_roi_coordinates(faces, training_case=True)
        except:
