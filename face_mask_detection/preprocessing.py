...
training_path = os.path.normpath(
    os.path.join(
        root,
        f"C:/Users/fabri/OneDrive/Escritorio/Proyecto/Dataset/images/Face-Mask/Step 5 - Train Test Roi Images/no-mask",
    )
)
export_path = os.path.normpath(
    os.path.join(
        root,
        f"C:/Users/fabri/OneDrive/Escritorio/Proyecto/Dataset/images/Face-Mask/Step 6 - Resize Images/no-mask",
    )
)
