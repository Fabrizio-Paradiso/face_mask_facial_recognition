...
def application_process(frame: numpy.ndarray) -> None:
    ...
    faces = face_recognition.FACE_CASCADE.detectMultiScale(
    ...
    try:
        ...
        recognition_prediction = recognition.recognition_prediction(
            recognition_features
        )
        frame_stream = add_match_to_frame(frame, recognition_prediction)
        create_bounding_box(
            faces, frame_stream, mask_prediction, recognition_prediction
        )
